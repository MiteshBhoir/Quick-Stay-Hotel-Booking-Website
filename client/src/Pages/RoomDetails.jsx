...
const RoomDetails = () => {
    ...
    // onSubmitHandler to check the availability and book the room 
    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col lg:flex-row mt-6 gap-6'>
                ...
                <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                    {room?.images.length > 1 && room.images.map((image, index) => (
                        <img src={image} alt="Room Image" key={index} onClick={() => setMainImage(image)}
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p >Guests will be allocated at the ground floor according to availability.You get a comfotable Two bedrooms apartment that has a true city feeling. The price quoted is for 2 guests, at the guest slot please mark the number of guests to get the exact price for groups.</p>
            </div>
            {/* Hosted By  */}
